      ...
      <div className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
          <div className="col-span-full lg:col-span-1">
            <a
              className="flex-none text-2xl font-bold text-transparent bg-gradient-to-r from-[#009245] to-[#FCEE21] bg-clip-text focus:outline-none focus:opacity-80"
              href="#"
              aria-label="Brand"
            >
              PetrichEdu
          ...
          <div className="col-span-2">
            ...
            <form>
              <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-lg p-2 dark:bg-neutral-900">
                ...
                <a
                  className="w-full sm:w-auto whitespace-nowrap p-3 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-[#009245] text-white  focus:outline-none focus:bg-[#FCEE21] focus:text-black disabled:opacity-50 disabled:pointer-events-none"
                  href="#"
                >
                  Subscribe
                </a>
              ...
              <p className="mt-3 text-sm text-gray-400">
                New courses or big discounts. Never spam.
              </p>
            </form>
          </div>
        </div>
        ...
        <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
          <div className="flex justify-between items-center">
            <p className="text-sm text-gray-400 dark:text-neutral-400">
              © 2024 Petrich. All rights reserved.
            </p>
          </div>
